...
const rawProducts: ReadonlyArray<[CatalogProduct["category"], string, string]> = [
  ["serum", "NIACINAMIDE 2% + SAPONIN PINK SERUM", "niacinamide-2-saponin-pink-serum"], ["serum", "GREEN APPLE CAPSULE SERUM", "green-apple-capsule-serum"], ["serum", "SUPER PDRN BOOSTER", "super-pdrn-booster"], ["serum", "GREEN RETINAL BEAN DROP SERUM", "green-retinal-bean-drop-serum"], ["serum", "CLOUD ROOT SOOTHING SERUM", "cloud-root-soothing-serum"], ["serum", "NAD + SLUSH RESET SERUM", "nad-slush-reset-serum"], ["serum", "LACTO CREAM SERUM", "lacto-cream-serum"], ["serum", "PERFECT RESURFACING SERUM", "perfect-resurfacing-serum"], ["serum", "HYALURON SEAL SERUM", "hyaluron-seal-serum"], ["serum", "HYALUCOGEN SERUM", "hyalucogen-serum"], ["serum", "PANTHENOL REGENERATIVE SERUM", "panthenol-regenerative-serum"], ["serum", "TIMELESS NOURISHING SERUM", "timeless-nourishing-serum"], ["serum", "PINK HYDRATION CAPSULE SERUM", "pink-hydration-capsule-serum"], ["serum", "HYDRA JELLY SMOOTHIE SERUM", "hydra-jelly-smoothie-serum"], ["serum", "RETINOL MATRIX REPAIR SERUM", "retinol-matrix-repair-serum"], ["serum", "DERMA ACTION REVITALIZING SERUM", "derma-action-revitalizing-serum"], ["serum", "HYDRO BOOST HYALURONIC ACID SERUM", "hydro-boost-hyaluronic-acid-serum"], ["serum", "LAYER BLENDING SERUM", "layer-blending-serum"], ["serum", "YUJA Vit.C BRIGHTENING SERUM", "yuja-vit-c-brightening-serum"], ["serum", "BETA CALMING REPAIR AMPOULE", "beta-calming-repair-ampoule"], ["serum", "DAILY GLUTA SHOT", "daily-gluta-shot"], ["serum", "POWER ANTIAGING SERUM", "power-antiaging-serum"], ["serum", "FIRMING SOLUTION (MULTI-PEPTIDE EYE SERUM)", "firming-solution"], ["serum", "DEPUFFING SOLUTION (CAFFEINE + EGCG EYE SERUM)", "depuffing-solution"],
  ...
  ["cream", "PDRN-EEDLE REVIVAL CREAM", "pdrn-needle-revival-cream"], ["cream", "QUERCETIN 1000 CALMING CREAM", "quercetin-1000-calming-cream"], ["cream", "GREEN BALANCING CREAM", "green-balancing-cream"], ["cream", "BERRY BOUNCE BALM", "berry-bounce-balm"], ["cream", "R.E.D BLEMISH CLEAR MOISTURE CREAM", "red-blemish-clear-moisture-cream"], ["cream", "GREEN FLAVONOID SOOTHING CREAM", "green-flavonoid-soothing-cream"],
